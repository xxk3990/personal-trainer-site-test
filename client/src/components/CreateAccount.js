      ...
      <div className="CreateAccount">
        <section className='add-user'>
          ...
          <form className = "login" onSubmit={handleSubmit(postUser)}>
            ...
            <span className='user-form-question' id="date-of-birth">Date of Birth: <input type='date' name='dob' className='date-input' min="1970-01-01" max="2024-12-31" {...register("dob", {required: true})}/></span>
